import type { VcsStatusRemoteResult, VcsStatusResult } from "@trumbo-code/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:Trumbo/TrumboCode.git")).toBe(
      "github.com/trumbo/trumbo-code",
    );
    expect(normalizeGitRemoteUrl("https://github.com/Trumbo/TrumboCode.git")).toBe(
      "github.com/trumbo/trumbo-code",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/Trumbo/TrumboCode")).toBe(
      "github.com/trumbo/trumbo-code",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:Trumbo/platform/TrumboCode.git")).toBe(
      "gitlab.com/trumbo/platform/trumbo-code",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/Trumbo/platform/TrumboCode.git")).toBe(
      "gitlab.com/trumbo/platform/trumbo-code",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:Trumbo/TrumboCode.git"),
    ).toBe("Trumbo/TrumboCode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/Trumbo/TrumboCode.git"),
    ).toBe("Trumbo/TrumboCode");
  });
});
