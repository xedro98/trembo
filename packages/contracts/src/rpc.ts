...
import {
  ...
  PLATFORM_ECOSYSTEM_WS_METHODS,
  ScheduleActiveResult,
  ScheduleCreateInput,
  ScheduleExecutionResult,
  ScheduleExecutionsInput,
  ScheduleIdInput,
  ScheduleListInput,
  ScheduleListResult,
...
export const WS_METHODS = {
  ...
  // Trumbo platform ecosystem (schedules, MCP, cloud infrastructure)
  scheduleList: PLATFORM_ECOSYSTEM_WS_METHODS.scheduleList,
  scheduleCreate: PLATFORM_ECOSYSTEM_WS_METHODS.scheduleCreate,
  scheduleDelete: PLATFORM_ECOSYSTEM_WS_METHODS.scheduleDelete,
  schedulePause: PLATFORM_ECOSYSTEM_WS_METHODS.schedulePause,
  scheduleResume: PLATFORM_ECOSYSTEM_WS_METHODS.scheduleResume,
  scheduleTrigger: PLATFORM_ECOSYSTEM_WS_METHODS.scheduleTrigger,
  scheduleActive: PLATFORM_ECOSYSTEM_WS_METHODS.scheduleActive,
  scheduleExecutions: PLATFORM_ECOSYSTEM_WS_METHODS.scheduleExecutions,
  scheduleStats: PLATFORM_ECOSYSTEM_WS_METHODS.scheduleStats,
  mcpListServers: PLATFORM_ECOSYSTEM_WS_METHODS.mcpListServers,
  mcpUpsertServer: PLATFORM_ECOSYSTEM_WS_METHODS.mcpUpsertServer,
  mcpToggleServer: PLATFORM_ECOSYSTEM_WS_METHODS.mcpToggleServer,
 ...
 * Not the persisted Trumbo Review model. Future review sessions should use
...
export const WsScheduleListRpc = Rpc.make(WS_METHODS.scheduleList, {
...
export const WsScheduleCreateRpc = Rpc.make(WS_METHODS.scheduleCreate, {
  payload: ScheduleCreateInput,
  success: ScheduleRecord,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsScheduleDeleteRpc = Rpc.make(WS_METHODS.scheduleDelete, {
  payload: ScheduleIdInput,
  success: Schema.Struct({ deleted: Schema.Boolean }),
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsSchedulePauseRpc = Rpc.make(WS_METHODS.schedulePause, {
  payload: ScheduleIdInput,
  success: ScheduleRecord,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsScheduleResumeRpc = Rpc.make(WS_METHODS.scheduleResume, {
  payload: ScheduleIdInput,
  success: ScheduleRecord,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsScheduleTriggerRpc = Rpc.make(WS_METHODS.scheduleTrigger, {
  payload: ScheduleIdInput,
  success: ScheduleExecutionResult,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsScheduleActiveRpc = Rpc.make(WS_METHODS.scheduleActive, {
  payload: Schema.Struct({}),
  success: ScheduleActiveResult,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsScheduleExecutionsRpc = Rpc.make(WS_METHODS.scheduleExecutions, {
  payload: ScheduleExecutionsInput,
  success: Schema.Struct({ executions: Schema.Array(ScheduleExecutionRecord) }),
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsScheduleStatsRpc = Rpc.make(WS_METHODS.scheduleStats, {
  payload: ScheduleIdInput,
  success: ScheduleStatsResult,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsMcpListServersRpc = Rpc.make(WS_METHODS.mcpListServers, {
  payload: Schema.Struct({}),
  success: McpServerListResult,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});
...
export const WsMcpToggleServerRpc = Rpc.make(WS_METHODS.mcpToggleServer, {
  payload: Schema.Struct({
    name: McpServerNameInput.fields.name,
...
export const WsMcpStartOAuthRpc = Rpc.make(WS_METHODS.mcpStartOAuth, {
  payload: McpServerNameInput,
  success: McpOAuthStartResult,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});

export const WsPlatformGetInfrastructureRpc = Rpc.make(WS_METHODS.platformGetInfrastructure, {
  payload: Schema.Struct({}),
  success: PlatformInfrastructureResult,
  error: Schema.Union([PlatformEcosystemError, EnvironmentAuthorizationError]),
});
...
export const WsRpcGroup = RpcGroup.make(
  ...
  WsSchedulePauseRpc,
  WsScheduleResumeRpc,
  WsScheduleTriggerRpc,
  WsScheduleActiveRpc,
  WsScheduleExecutionsRpc,
  WsScheduleStatsRpc,
  WsMcpListServersRpc,
