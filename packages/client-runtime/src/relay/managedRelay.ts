...
import { encodeOAuthScope, oauthScopeSetEquals } from "@trumbo-code/shared/oauthScope";
import { decodeRelayJwt } from "@trumbo-code/shared/relayJwt";
import { withRelayClientTracing } from "@trumbo-code/shared/relayTracing";
import { normalizeSecureRelayUrl } from "@trumbo-code/shared/relayUrl";
...
>()("@trumbo-code/client-runtime/relay/managedRelay/ManagedRelayDpopSigner") {}
...
>()("@trumbo-code/client-runtime/relay/managedRelay/ManagedRelayClient") {}
      ...
      const response = yield* client.token
        .exchangeDpopAccessToken({
          ...
          payload: {
            ...
            subject_token_type: RelayPlatformSubjectTokenType,
