import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@trumbo-code/contracts";
import { resolveRemotePairingTarget } from "@trumbo-code/shared/remote";
...
>()("@trumbo-code/client-runtime/connection/onboarding/ConnectionOnboarding") {}
