import { AuthStandardClientScopes, EnvironmentId } from "@trumbo-code/contracts";
...
describe("connection onboarding", () => {
  it.effect("prepares a persisted bearer registration from pairing details", () =>
    Effect.gen(function* () {
      ...
      expect(tokenParams.get("client_label")).toBe("Trumbo Code Test");
    }),
  );
