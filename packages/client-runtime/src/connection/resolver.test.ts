import { EnvironmentId, type DesktopSshEnvironmentTarget } from "@trumbo-code/contracts";
import { RelayEnvironmentConnectScope } from "@trumbo-code/contracts/relay";
import { RelayClientTracer } from "@trumbo-code/shared/relayTracing";
