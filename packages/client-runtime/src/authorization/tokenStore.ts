...
import { RelayManagedEndpoint } from "@trumbo-code/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@trumbo-code/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@trumbo-code/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
