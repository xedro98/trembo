import type { OrchestrationThreadDetailSnapshot, ThreadId } from "@trumbo-code/contracts";
...
>()("@trumbo-code/client-runtime/state/threadSnapshotHttp/ThreadSnapshotLoader") {}
