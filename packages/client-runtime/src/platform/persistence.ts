...
>()("@trumbo-code/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@trumbo-code/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@trumbo-code/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@trumbo-code/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
