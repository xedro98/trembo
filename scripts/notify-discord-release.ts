  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Trumbo Code prerelease is available for nightly testers."
          : "A new Trumbo Code latest release is available.",
...
).pipe(Command.withDescription("Post a Trumbo Code release announcement to Discord."));
