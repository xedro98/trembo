...
import { RelayApi } from "@trumbo-code/contracts/relay";
...
export default class Api extends Cloudflare.Worker<Api>()(
  ...
  Effect.gen(function* () {
    ...
    const platformBaseUrl = yield* Config.string("TRUMBO_PLATFORM_URL").pipe(
      Config.withDefault("https://platform.trumbo.dev"),
    );
