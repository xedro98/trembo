import type { RelayDeviceRegistrationRequest } from "@trumbo-code/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "dev.trumbo.trumbo-code.preview" as RelayDeviceRegistrationRequest["bundleId"],
    ...
    return Effect.gen(function* () {
      ...
      expect(insertedValues).toEqual([
        expect.objectContaining({
          userId: "user-2",
          deviceId: "device-1",
          bundleId: "dev.trumbo.trumbo-code.preview",
          apsEnvironment: "production",
