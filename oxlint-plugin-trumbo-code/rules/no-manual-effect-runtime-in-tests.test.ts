...
const rule = createOxlintRuleHarness("trumbo-code/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("trumbo-code/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("trumbo-code/no-manual-effect-runtime-in-tests");
