...
import { projectThreadAwareness } from "@trumbo-code/shared/agentAwareness";
...
import {
  ...
  signRelayJwt,
} from "@trumbo-code/shared/relayJwt";
...
>()("trumbo-code/relay/AgentAwarenessRelay") {}
      ...
      switch (startupState) {
        case "waiting-for-link":
          yield* Effect.logInfo(
            "agent activity publishing standby; waiting for Trumbo Connect link reconciliation",
          );
          break;
        case "disabled":
          yield* Effect.logInfo(
            "agent activity publishing disabled by Trumbo Connect configuration",
          );
          break;
        case "enabled":
