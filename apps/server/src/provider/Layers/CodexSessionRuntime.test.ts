...
import { DEFAULT_MODEL, ThreadId } from "@trumbo-code/contracts";
...
describe("buildCodexDeveloperInstructions", () => {
  it("appends runtime info after the mode instructions", () => {
    ...
    NodeAssert.match(instructions, /Trumbo Code/);
...
describe("Trumbo browser developer instructions", () => {
...
describe("hasConfiguredMcpServer", () => {
  it("detects inline Codex MCP configuration arguments", () => {
    ...
    NodeAssert.equal(
      hasConfiguredMcpServer(["-c", 'mcp_servers.trumbo-code.url="http://127.0.0.1/mcp"']),
      true,
    );
  });
});
