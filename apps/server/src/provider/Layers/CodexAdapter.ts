...
import { getModelSelectionStringOptionValue } from "@trumbo-code/shared/model";
        ...
        const runtimeInput: CodexSessionRuntimeOptions = {
          ...
          ...(mcpSession
            ? {
                ...
                appServerArgs: [
                  "-c",
                  `mcp_servers.trumbo-code.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.trumbo-code.bearer_token_env_var="T3_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
