import { type GrokSettings, ProviderDriverKind } from "@trumbo-code/contracts";
...
import { normalizeModelSlug } from "@trumbo-code/shared/model";
...
const T3_CODE_OAUTH_REFERRER = "trumbo-code";
