...
>()("trumbo-code/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Trumbo Code could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Trumbo Code still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
