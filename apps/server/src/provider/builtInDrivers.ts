...
import { TrumboDriver, type TrumboDriverEnv } from "./Drivers/TrumboDriver.ts";
 ...
 *
 * Native Trumbo desktop builds ship Trumbo as the sole provider.
 */
export const BUILT_IN_DRIVERS: ReadonlyArray<AnyProviderDriver<BuiltInDriversEnv>> =
  isNativeTrumboDesktopBuild() ? [TrumboDriver] : ALL_BUILT_IN_DRIVERS;
