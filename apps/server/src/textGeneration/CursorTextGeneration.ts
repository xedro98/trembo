...
import { type CursorSettings, type ModelSelection } from "@trumbo-code/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@trumbo-code/shared/git";
import { extractJsonObject } from "@trumbo-code/shared/schemaJson";
  ...
  const runCursorJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* makeCursorAcpRuntime({
        ...
        cwd,
        clientInfo: { name: "trumbo-code-git-text", version: "0.0.0" },
