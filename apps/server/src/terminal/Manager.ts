...
import { makeKeyedCoalescingWorker } from "@trumbo-code/shared/KeyedCoalescingWorker";
import { HostProcessPlatform } from "@trumbo-code/shared/hostProcess";
import { getTerminalLabel } from "@trumbo-code/shared/terminalLabels";
...
>()("trumbo-code/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("TRUMBO_CODE_")) {
    return true;
  }
