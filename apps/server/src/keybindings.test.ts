import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@trumbo-code/contracts";
...
import { KeybindingsConfigError } from "@trumbo-code/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "trumbo-code-keybindings-test-",
        }),
      ),
    ),
  );
