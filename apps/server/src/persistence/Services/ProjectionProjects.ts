 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@trumbo-code/contracts";
...
>()("trumbo-code/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
