import { EnvironmentHttpApi } from "@trumbo-code/contracts";
...
import { disableTailscaleServe, ensureTailscaleServe } from "@trumbo-code/tailscale";

// Effect's default preemptive shutdown waits 20s before finalizing request scopes.
// Trumbo's primary transport is long-lived WebSocket RPC, whose Effect scope finalizer
...
const RuntimeCoreDependenciesLive = ReactorLayerLive.pipe(
  ...
  Layer.provideMerge(
    Layer.mergeAll(
      ...
      TrumboPlatformTokenManager.layer.pipe(Layer.provide(ServerSecretStore.layer)),
      ...
      Effect.gen(function* () {
        ...
        yield* Effect.forkScoped(
          Effect.sleep("250 millis").pipe(
            ...
            Effect.tap(() => Effect.logInfo("Trumbo Connect desired link reconciled on startup")),
            Effect.catch((cause) =>
              Effect.logWarning("Failed to reconcile Trumbo Connect desired link on startup", {
                cause,
              }),
            ),
          ),
