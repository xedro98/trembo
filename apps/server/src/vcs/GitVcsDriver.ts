  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const commitEnv: NodeJS.ProcessEnv = {
        ...
        GIT_AUTHOR_NAME: "Trumbo Code",
        GIT_AUTHOR_EMAIL: "trumbo-code@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Trumbo Code",
        GIT_COMMITTER_EMAIL: "trumbo-code@users.noreply.github.com",
      };
