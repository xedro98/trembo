...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@trumbo-code/contracts";
import { VcsUnsupportedOperationError } from "@trumbo-code/contracts";
...
>()("trumbo-code/vcs/VcsDriverRegistry") {}
