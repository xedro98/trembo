import { ProjectId } from "@trumbo-code/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@trumbo-code/shared/projectScripts";
...
>()("trumbo-code/project/ProjectSetupScriptRunner") {}
