...
import { SourceControlProviderError, type ChangeRequest } from "@trumbo-code/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set TRUMBO_CODE_BITBUCKET_EMAIL and TRUMBO_CODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
