...
import {
  ...
  type DpopPublicJwk,
} from "@trumbo-code/shared/dpop";
import { RELAY_HEALTH_REQUEST_TYP, RELAY_MINT_REQUEST_TYP } from "@trumbo-code/shared/relayJwt";
...
import { expectPathEndsWith } from "./test/testPlatform.ts";
    ...
    const appLayer = servedRoutesLayer.pipe(
      ...
      Layer.provide(
        Layer.mock(CloudCliTokenManager.CloudCliTokenManager)({
          get: Effect.die(new Error("Unexpected Trumbo Connect CLI authorization request.")),
      ...
      Layer.provide(
        Layer.mock(TrumboPlatformTokenManager.TrumboPlatformTokenManager)({
...
it.layer(NodeServices.layer)("server router seam", (it) => {
  ...
  it.effect("serves the documented Trumbo Connect mint credential endpoint", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest();
  ...
  it.effect("serves signed Trumbo Connect environment health checks", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest();
  ...
  for (const desktopOrigin of ["trumbo://app", "trumbo-dev://app"]) {
  ...
  it.effect("routes websocket rpc subscribeServerConfig streams snapshot then update", () =>
    Effect.gen(function* () {
      ...
      if (first?.type === "snapshot") {
        ...
        assert.isTrue(expectPathEndsWith(first.config.observability.logsDirectoryPath, "/logs"));
  ...
  it.effect("enriches replayed project events with repository identity metadata", () =>
    Effect.gen(function* () {
      const repositoryIdentity = {
        canonicalKey: "github.com/trumbo/trumbo-code",
        locator: {
          source: "git-remote" as const,
          remoteName: "origin",
          remoteUrl: "git@github.com:Trumbo/trumbo-code.git",
        },
        displayName: "Trumbo/trumbo-code",
        provider: "github",
        owner: "Trumbo",
        name: "trumbo-code",
      };
      ...
      Effect.gen(function* () {
        ...
        const refreshStatus = vi.fn((_: string) =>
          Effect.succeed({
            ...
            hasPrimaryRemote: true,
            isDefaultRef: false,
            refName: "trumbo-code/bootstrap-refName",
            hasWorkingTreeChanges: false,
            workingTree: {
              files: [],
              insertions: 0,
            ...
            client[ORCHESTRATION_WS_METHODS.dispatchCommand]({
              ...
              bootstrap: {
                ...
                prepareWorktree: {
                  ...
                  baseBranch: "main",
                  branch: "trumbo-code/bootstrap-refName",
        ...
        assert.deepEqual(createWorktree.mock.calls[0]?.[0], {
          ...
          newRefName: "trumbo-code/bootstrap-refName",
          baseRefName: "main",
          path: null,
        });
