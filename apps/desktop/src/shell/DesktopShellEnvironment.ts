...
>()("@trumbo-code/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__TRUMBO_CODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__TRUMBO_CODE_ENV_${name}_END__`;
