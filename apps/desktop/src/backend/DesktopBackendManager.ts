...
import { waitForHttpReady as waitForHttpReadyShared } from "@trumbo-code/shared/httpReadiness";
...
export interface DesktopBackendStartConfig {
  ...
  // TRUMBO_CODE_HOME can't pin the WSL backend to /mnt/c/...\.trumbo-code.
