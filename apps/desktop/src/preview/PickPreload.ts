...
const OVERLAY_ATTRIBUTE = "data-trumbo-code-annotation-ui";
...
function startAnnotation(): void {
  ...
  cursorStyle.textContent = `html[data-trumbo-code-annotation-tool] body, html[data-trumbo-code-annotation-tool] body * { cursor: crosshair !important; } [${OVERLAY_ATTRIBUTE}], [${OVERLAY_ATTRIBUTE}] * { cursor: default !important; } [${OVERLAY_ATTRIBUTE}] input[type=number]::-webkit-inner-spin-button, [${OVERLAY_ATTRIBUTE}] input[type=number]::-webkit-outer-spin-button { appearance:none; margin:0; }`;
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-trumbo-code-annotation-tool", tool);
  };
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-trumbo-code-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
