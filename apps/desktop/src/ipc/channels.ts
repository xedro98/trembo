...
export const TRUMBO_AUTH_GET_STATE_CHANNEL = "desktop:trumbo-auth-get-state";
export const TRUMBO_AUTH_START_SIGN_IN_CHANNEL = "desktop:trumbo-auth-start-sign-in";
export const TRUMBO_AUTH_CANCEL_SIGN_IN_CHANNEL = "desktop:trumbo-auth-cancel-sign-in";
export const TRUMBO_AUTH_SIGN_OUT_CHANNEL = "desktop:trumbo-auth-sign-out";
export const TRUMBO_AUTH_REFRESH_CHANNEL = "desktop:trumbo-auth-refresh";
export const TRUMBO_AUTH_STATE_CHANGE_CHANNEL = "desktop:trumbo-auth-state-change";
