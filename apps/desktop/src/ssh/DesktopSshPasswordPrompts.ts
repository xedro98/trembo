import type { DesktopSshPasswordPromptRequest } from "@trumbo-code/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@trumbo-code/contracts";
import type { SshPasswordRequest } from "@trumbo-code/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Trumbo Code window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@trumbo-code/desktop/ssh/DesktopSshPasswordPrompts") {}
