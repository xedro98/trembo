...
import type { DesktopUpdateState } from "@trumbo-code/contracts";
...
function makeHarness(options: UpdatesHarnessOptions = {}) {
  ...
  const environmentLayer = DesktopEnvironment.layer({
    ...
    homeDirectory: `/tmp/trumbo-code-desktop-updates-home-${process.pid}`,
    platform: "darwin",
    processArch: "x64",
    appVersion: "1.2.3",
    appPath: "/repo",
    ...
    Layer.provide(
      Layer.mergeAll(
        ...
        DesktopConfig.layerTest({
          TRUMBO_CODE_HOME: `/tmp/trumbo-code-desktop-updates-test-${process.pid}`,
          TRUMBO_CODE_DESKTOP_MOCK_UPDATES: "true",
          TRUMBO_CODE_DESKTOP_MOCK_UPDATE_SERVER_PORT: "4141",
          ...options.env,
        }),
      ),
    ),
