...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly devRemoteTrumboServerEntryPath: Option.Option<string>;
...
>()("@trumbo-code/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "Trumbo";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.trumboCodeHome, () =>
    path.join(homeDirectory, ".trumbo-code"),
  );
  ...
  const userDataDirName = isDevelopment ? "trumbo-dev" : "trumbo-code";
  const legacyUserDataDirName = isDevelopment ? "Trumbo Code (Dev)" : "Trumbo Code";
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteTrumboServerEntryPath: config.devRemoteTrumboServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "dev.trumbo.trumbo-code.dev" : "dev.trumbo.trumbo-code",
    ),
    linuxDesktopEntryName: isDevelopment ? "trumbo-dev.desktop" : "trumbo-code.desktop",
    linuxWmClass: isDevelopment ? "trumbo-dev" : "trumbo-code",
    userDataDirName,
