import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@trumbo-code/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@trumbo-code/shared/observability";
...
>()("@trumbo-code/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
