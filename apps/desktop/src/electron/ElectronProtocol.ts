...
export const DESKTOP_PRODUCTION_SCHEME = "trumbo-code";
export const DESKTOP_DEVELOPMENT_SCHEME = "trumbo-dev";
...
>()("@trumbo-code/desktop/electron/ElectronProtocol") {}
...
export function makeDesktopContentSecurityPolicy(input: DesktopProtocolRegistrationInput): string {
  ...
  return [
    ...
    `style-src 'self' ${input.scheme}: 'unsafe-inline'`,
...
async function proxyRequest(
  ...
  return withCorsHeaders(withContentSecurityPolicy(response, contentSecurityPolicy), request);
}
