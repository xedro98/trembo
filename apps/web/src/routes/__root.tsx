import { type ServerLifecycleWelcomePayload } from "@trumbo-code/contracts";
import { scopedProjectKey, scopeProjectRef } from "@trumbo-code/client-runtime/environment";
...
import { TrumboAuthProviderRefresh } from "../components/trumbo-auth/TrumboAuthProviderRefresh";
import { TrumboLoginGate } from "../components/trumbo-auth/TrumboLoginGate";
...
function RootRouteView() {
  ...
  if (authGateState.status !== "authenticated" && authGateState.status !== "hosted-static") {
    return (
      <>
        <DocumentTitleSync />
        <AppErrorBoundary label="auth-gate">
          <Outlet />
        </AppErrorBoundary>
      </>
    );
  ...
  const appShell = (
    <TrumboLoginGate>
      <CommandPalette>
        <AppSidebarLayout>
          <AppErrorBoundary label="workspace">
            <Outlet />
          </AppErrorBoundary>
        </AppSidebarLayout>
      </CommandPalette>
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        {primaryEnvironmentAuthenticated ? <TrumboAuthProviderRefresh /> : null}
