...
import { RelayWebClientId } from "@trumbo-code/contracts/relay";
...
import { type RpcSession } from "@trumbo-code/client-runtime/rpc";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_TRUMBO_CODE_RELAY_URL", "https://relay.example.test");
