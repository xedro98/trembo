...
import type { EnvironmentCloudLinkStateResult } from "@trumbo-code/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read Trumbo Connect link state.";
  }
