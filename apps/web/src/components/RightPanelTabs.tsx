import type { ContextMenuItem, PreviewSessionSnapshot } from "@trumbo-code/contracts";
...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the Trumbo Code desktop app.",
