...
import type { ScopedThreadRef, ServerProviderSkill } from "@trumbo-code/contracts";
import {
...
function ChatMarkdown({
  ...
  // hast renderer overrides for react-markdown must close over render-scoped state
  // (skills, theme, link metadata, etc.); these are not React components.
  /* eslint-disable react/no-unstable-nested-components -- hast renderers for react-markdown */
