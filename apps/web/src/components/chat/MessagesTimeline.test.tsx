import { EnvironmentId, MessageId } from "@trumbo-code/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/trumbo-code/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/trumbo-code"
      />,
    );

    expect(markup).toContain("trumbo-code/apps/web/src/session-logic.ts");
    expect(markup).not.toContain(
      "C:/Users/mike/dev-stuff/trumbo-code/apps/web/src/session-logic.ts",
    );
  });
