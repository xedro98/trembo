import type { LocalApi, ScopedThreadRef } from "@trumbo-code/contracts";
import { isAtomCommandInterrupted } from "@trumbo-code/client-runtime/state/runtime";
import { isPreviewableUrl } from "@trumbo-code/shared/preview";
