...
import { getDriverOption, getVisibleDriverOptions } from "./providerDriverMeta";
...
const buildProviderSettings = () =>
  getVisibleDriverOptions().map((definition) => ({
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Trumbo Code looks across the app."
          resetAction={
            theme !== "system" ? (
      ...
      <SettingsSection title="About">
        ...
        <SettingsRow
          ...
          control={
            <Button size="xs" variant="outline" onClick={() => openSettingsModal("diagnostics")}>
              View diagnostics
            </Button>
          }
        />
...
export function ProviderSettingsPanel() {
  ...
  const visibleProviderSettings = buildProviderSettings().filter(
    (providerSettings) =>
