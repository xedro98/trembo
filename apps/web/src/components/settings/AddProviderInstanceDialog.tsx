...
import { DRIVER_OPTION_BY_VALUE, getVisibleDriverOptions } from "./providerDriverMeta";
 ...
 * `ProviderInstanceId` in `@trumbo-code/contracts`.
 */
...
const DEFAULT_DRIVER_OPTION = getVisibleDriverOptions()[0]!;
const DEFAULT_DRIVER_KIND = DEFAULT_DRIVER_OPTION.value;
          ...
          >
            <AnimatedHeight>
              <div className={cn("grid gap-2", wizardStep !== 0 && "hidden")}>
                ...
                >
                  {getVisibleDriverOptions().map((option) => {
