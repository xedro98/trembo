...
import { TrumboLogoSvg, trumboLogoClassName } from "./TrumboLogoSvg";
...
export const TrumboIcon: Icon = ({ className, ...props }) => (
  <TrumboLogoSvg {...props} className={trumboLogoClassName(className)} />
);
