import { scopedThreadKey } from "@trumbo-code/client-runtime/environment";
import type { ScopedThreadRef, TurnId } from "@trumbo-code/contracts";
...
export const useDiffPanelStore = create<DiffPanelStoreState>()(
  persist(
    ...
    {
      name: "trumbo-code:diff-panel-state:v1",
      version: 1,
