...
/** True when a provider is configured for the workspace, even if models are gated on auth. */
export function isProviderInstanceConfiguredForSetup(entry: ProviderInstanceEntry): boolean {
