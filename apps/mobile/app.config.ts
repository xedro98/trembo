...
const isIosPersonalTeamBuild = repoEnv.TRUMBO_CODE_IOS_PERSONAL_TEAM === "1";

const personalTeamBundleIdentifier = repoEnv.TRUMBO_CODE_IOS_PERSONAL_TEAM_BUNDLE_ID?.trim();
...
if (
  ...
  throw new Error(
    "TRUMBO_CODE_IOS_PERSONAL_TEAM_BUNDLE_ID must be a reverse-DNS identifier such as com.example.trumbo-code when TRUMBO_CODE_IOS_PERSONAL_TEAM=1.",
  );
}
...
const VARIANT_CONFIG = {
  development: {
    appName: "Trumbo Code Dev",
    scheme: "trumbo-dev",
    iosBundleIdentifier: "dev.trumbo.trumbo-code.dev",
    androidPackage: "dev.trumbo.trumbo-code.dev",
    relyingParty: "clerk.trumbo.dev",
    assets: DEVELOPMENT_ASSETS,
  },
  preview: {
    appName: "Trumbo Code Preview",
    scheme: "trumbo-code-preview",
    iosBundleIdentifier: "dev.trumbo.trumbo-code.preview",
    androidPackage: "dev.trumbo.trumbo-code.preview",
    relyingParty: "clerk.trumbo.dev",
  ...
  production: {
    appName: "Trumbo Code",
    scheme: "trumbo-code",
    iosBundleIdentifier: "dev.trumbo.trumbo-code",
    androidPackage: "dev.trumbo.trumbo-code",
    relyingParty: "clerk.trumbo.dev",
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Trumbo Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    // Pin code signing to the Trumbo team so non-interactive `expo run:ios`
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Trumbo Code to connect to Trumbo Code servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      ...
      {
        cameraPermission:
          "Allow Trumbo Code to access your camera so you can scan pairing QR codes.",
  ...
  extra: {
    ...
    relay: {
      url: repoEnv.TRUMBO_CODE_RELAY_URL ?? null,
    },
    clerk: {
