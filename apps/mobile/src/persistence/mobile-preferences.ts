...
const PREFERENCES_KEY = "trumbo-code.preferences";
const PREFERENCES_FALLBACK_KEY = "trumbo-code.preferences.fallback";
...
>()("@trumbo-code/mobile/persistence/MobilePreferencesStore") {}
