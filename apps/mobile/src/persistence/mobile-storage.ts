...
const CONNECTIONS_KEY = "trumbo-code.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "trumbo-code.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "trumbo-code.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "trumbo-code.recent-thread-shortcuts";
...
>()("@trumbo-code/mobile/persistence/MobileStorage") {}
