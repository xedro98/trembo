import { isTransportConnectionErrorMessage } from "@trumbo-code/client-runtime/errors";
import type { EnvironmentShellStatus } from "@trumbo-code/client-runtime/state/shell";
import {
  CommandId,
  EnvironmentId,
  IsoDateTime,
