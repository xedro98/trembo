...
import { ConnectionTransientError } from "@trumbo-code/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "trumbo-code.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "trumbo-code.connections";
