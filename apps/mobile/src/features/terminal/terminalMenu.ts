import { type KnownTerminalSession } from "@trumbo-code/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@trumbo-code/contracts";
...
} from "@trumbo-code/shared/terminalLabels";
