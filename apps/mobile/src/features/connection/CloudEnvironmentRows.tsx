...
/**
 * "Trumbo Connect" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Trumbo Connect
 * onboarding sheet.
 */
export function CloudEnvironmentRows(props: {
  ...
  /**
   * Hide the "Trumbo Connect" section title + refresh button for hosts that
