import type { EnvironmentProject } from "@trumbo-code/client-runtime/state/shell";
import { EnvironmentId, ProjectId, ProviderInstanceId } from "@trumbo-code/contracts";
...
const projects: ReadonlyArray<EnvironmentProject> = [
  {
    ...
    id: ProjectId.make("trumbo-code"),
    title: "Trumbo Code",
    workspaceRoot: "/workspace/trumbo-code",
