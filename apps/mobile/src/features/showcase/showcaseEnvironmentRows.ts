...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.trumbo-code.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.trumbo-code.sh",
  wsBaseUrl: "wss://pocket-pi.trumbo-code.sh",
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.trumbo-code.sh",
    isRelayManaged: true,
