...
describe("isLegalDocumentUrl", () => {
  it.each([
    "https://trumbo.dev/legal",
    "https://trumbo.dev/legal/",
    "https://trumbo.dev/privacy-policy?source=app",
    "https://trumbo.dev/terms-of-service#updates",
    "https://trumbo.dev/security-policy",
  ])("allows a configured legal document: %s", (url) => {
    expect(isLegalDocumentUrl(url)).toBe(true);
  });

  it.each([
    "https://trumbo.dev/download",
