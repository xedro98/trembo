...
- review threads/comments/diffs: key by provider CR ID and head SHA/version when available; fetch on demand for Trumbo Review
...
## Trumbo Review Design Constraint
...
- The provider API includes the review operations needed by future Trumbo Review work, even if they are capability-gated.
