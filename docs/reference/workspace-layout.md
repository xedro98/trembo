...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@trumbo-code/shared/git`, `@trumbo-code/shared/DrainableWorker`) — no barrel index.
